...
function tsuyuri_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'tsuyuri' ),
	) );
 ...
 */
function tsuyuri_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'tsuyuri_content_width', 640 );
}
add_action( 'after_setup_theme', 'tsuyuri_content_width', 0 );
...
function tsuyuri_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'tsuyuri' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
function tsuyuri_scripts() {
	wp_enqueue_style( 'tsuyuri-style', get_stylesheet_uri() );
